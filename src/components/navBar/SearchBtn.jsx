...
function SearchBtn() {
    ...
    return (
        ...
        className={` relative w-[98%] h-10 top-7 flex items-center  bg-[#636366] border-[1px] border-transparent  rounded-[8px] shadow-searchShadow text-sm sm:text-xl transition-all duration-300`}>
